...
var fs_1 = require("fs");
var binary_search_tree_1 = require("@datastructures-js/binary-search-tree");
var Room = /** @class */ (function () {
    function Room(room) {
        ...
        this.availabilityTree = new binary_search_tree_1.BinarySearchTree();
    }
    /*
        ...
        Return: boolean
    */
    Room.prototype.hasAvailability = function (checkin, checkout) {
    ...
    /*
        ...
        Return: void
    */
    Room.prototype.bookReservation = function (checkin, checkout) {
...
// load json data
var rawRoomData = (0, fs_1.readFileSync)('rooms.json', 'utf-8');
var rooms = JSON.parse(rawRoomData.toString());
var rawReservationData = (0, fs_1.readFileSync)('reservations.json', 'utf-8');
var reservations = JSON.parse(rawReservationData.toString());
var rawRequestData = (0, fs_1.readFileSync)('requests.json', 'utf-8');
var requests = JSON.parse(rawRequestData.toString());
...
for (var i in rooms) {
    ...
    var bookings = reservations.filter(function (reservation) { return reservation.room_id == newRoom.id; });
...
hotel.smoking.sort(function (room1, room2) { return room1.rate - room2.rate; });
hotel.nonsmoking.sort(function (room1, room2) { return room1.rate - room2.rate; });
